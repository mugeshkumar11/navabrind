      ...
      <section className="details">
        <div className="detailsflex">
          <div className="detailleft">
            ...
            <h4>
              Therefore, employees are the most valuable assets an organization
              has. It's their abilities, knowledge, and experience that can't be
              replaced. So, going forward, organizations need to place emphasis
              and importance on the contribution that employees that they have
              in order to propel themselves ahead.
            </h4>
          </div>
