...
const Login = () => {
    ...
    const [validate, setvalidate] = useState({employeeid:"",employeepassword:""});
  ...
  const handlesubmit=(e) =>{
    ...
    if (validate.employeeid === "" && validate.employeepassword==="") {
      ...
      seterror("please enter the id ")
       ...
       if(validate.employeeid === item.employeeid && validate.employeepassword === item.employeepassword){
    ...
    <section className="container">
      <div className="logflex">
        ...
        <div className="usercredent">
            ...
            onChange={(eve)=>setvalidate({...validate,employeeid:eve.target.value})}
          ></input>
          <input
            type="password"
            placeholder={"EmployeePassword"}
            value={validate.employeepassword}
            onChange={(eve)=>setvalidate({...validate,employeepassword:eve.target.value})}
          ></input>
